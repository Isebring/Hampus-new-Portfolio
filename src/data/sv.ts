export default {
    ...
    reachOut: "Hör gärna av dig",
    reachOutText: "Jag tar gärna ett snack om vad som helst",
    ...
    hobbiesText2: "Ett sätt att rensa huvudet och känna mig som ny, träning är en viktig del av mitt dagliga liv.",
    hobbiesTitle3: "Musik",
    hobbiesText3: "Musik har varit en del av mitt liv så länge jag kan minnas. Oavsett vilket humör jag är finns alltid en låt som kan hjälpa mig ta igenom det. Jag spelar också gitarr då och då.",
