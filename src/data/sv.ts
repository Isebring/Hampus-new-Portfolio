export default {
    ...
    download2: "Ladda ned Uppsats",
    closePDF: "Stäng PDF",
    cvTitle: "CV & Uppsats",
    portfolioTitle: "Min Portfolio",
    portfolioTitle0: "DH Solutions Design",
    portfolioText0: "Under min period på DH Solutions tog jag fram ett designkoncept av en tidrapport för kund. Detta designkoncept användes och går att läsa om på länken.",
    ...
    portfolioTitle6: "Creative Paper",
    portfolioText6: "Jag och andra studenter skapade denna webbshopp med React, TypeScript och Mantine. Vi arbetade exempelvis med Reacts context API för att skapa en kundvagn.",
