export default {
    ...
    download2: "Download Thesis",
    closePDF: "Close PDF",
    cvTitle: "CV & Thesis",
    portfolioTitle: "My Portfolio",
    portfolioTitle0: "DH Solutions Design",
    portfolioText0: "During my time at DH Solutions, I developed a design concept for a time report for a client. This design concept was used and can be read about at the following link.",
    ...
    portfolioText6: "Me and fellow students created this stationery ecommerce store with React, TypeScript and Mantine. We worked with the context API from React for the shopping cart.",
